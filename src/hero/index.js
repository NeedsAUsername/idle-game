    ...
    return (
      <div className={hero.leveledUp ? 'hero level-up' : 'hero'}>
        ...
        <ul className="resource-list">
          <li className="stat level">Level: {hero.level}</li>
        ...
        <ul className="stat-list"><h3>Character Details</h3>
          <li className="stat">Attack Range: {hero.minRange} ~ {hero.maxRange}</li>
